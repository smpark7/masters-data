...
[Mesh]
  file = '../msfr-2d-core-temp-refine.e'
#  file = '../msfr-ins-2d-temp-refine_exodus.e'
...
[Functions]
  [./velFunc]
    type = ParsedFunction
    value = '-508.5025 * 4 * ((y - 100) / 18.75 - ((y - 100) / 18.75)^2) * (1-exp(-t/2))'
  [../]
  [./ux_ic]
...
[UserObjects]
  [./soln]
    ...
    mesh = '../msfr-ins-2d-temp-refine_exodus.e'
    system_variables = 'ux uy p'
    timestep = LATEST
    execute_on = INITIAL
  [../]
[]
